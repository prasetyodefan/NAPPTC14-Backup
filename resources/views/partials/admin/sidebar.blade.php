    ...
    <div class="p-6 relative">
        ...
        <nav>
            <ul>
                ...
                <li class="mb-4">
                    <a href="{{ route('admin.news.index') }}" class="flex items-center text-gray-300 hover:text-white">
                        <svg class="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                ...
                <li class="mb-4">
                    <a href="{{ route('admin.categories.index') }}" class="flex items-center text-gray-300 hover:text-white">
                        <svg class="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
